...
function displayImg() {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        imgEl.innerHTML += '<img id="img1" class="shadow-2xl bg-white rounded-lg" alt="Picture Load Failed! " src="/static/img/imgrec/' + album[i] + '.jpg"  width="10%" style="display: inline; margin: 10px; " />'
    }
